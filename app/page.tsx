  ...
  return (
    <main className='relative items-center overflow-hidden '>
        ...
        <div className='flex justify-center'>
          <button className='bg-white border-black border-2 px-5 cursor-pointer mx-[15px] text-xl rounded-md '>
            Github
          ...
          <a href="#_" className="px-5 py-2.5 mx-[15px] relative rounded group font-medium text-white inline-block">
